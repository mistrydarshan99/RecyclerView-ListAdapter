...
class MainActivity : AppCompatActivity() {
  ...
  private var userAdapter = UserAdapter {
    Toast.makeText(this, "Position is $it", Toast.LENGTH_SHORT).show()
  }
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    userAdapter.items = listOf(User(1, "Darshan 1"), User(1, "Hardik 1"), User(1, "Dipen 1"))
  }
